...
export default class Color {
     ...
     */
    static hex(string: string, system: 'hsl' | 'rgb' | null) {
     ...
     */
    static rgb(string: string | null, system: 'hsl' | 'hex' | null) {
     ...
     */
    static hsl(string: string | null, system: 'hex' | 'rgb' | null) {
